...
do
{
    ...
    switch (menuSelection)
    {
        ...
        case "3":
            //3. Ensure animal ages and physcal descriptions are completei
            for (int i = 0; i < maxPets; i++)
            {
                ...
                if (ourAnimals[i, 0] == "ID #: ")
                {
                    ...
                    do
                    {
                        Console.WriteLine($"Enter an age for ID #: c04");
                        readResult = Console.ReadLine();
                        int age;
                        if (int.TryParse(readResult, out age))
                        {
                            checkAge = true;
        ...
        case "4":
            ...
            for (int i = 0; i < maxPets; i++)
            {
                ...
                if (ourAnimals[i, 0] == "ID #: ")
                {
                    ...
                    do
                    {
                        Console.WriteLine($"Enter a nickname for ID #: c04");
                        readResult = Console.ReadLine();
